...
### **Install nf-mouse**
     <Steps>
       1. **Release**
          ...
          Download nf-mouse pipeline:
          <CommandOutputs>
            <span slot="command">
              ```bash
              nextflow pull scilus/nf-mouse -r main
              nextflow run nf-mouse/main.nf -r main --help
              ```
            </span>
            ...
            <span slot="output">
              ...
              Launching `https://github.com/scilus/nf-mouse` [crazy_marconi] DSL2 - revision: ac50d4b1c5 [main]
       ...
       2. **For developers**
          ...
          Clone nf-mouse pipeline repository:
          ...
          <Tabs>
            <TabItem label="Command">
              ```bash
             git clone https://github.com/scilus/nf-mouse.git
              ```
            </TabItem>
          </Tabs>
          </details>
          ...
          <Tabs>
            <TabItem label="Command">
              ```bash
             git clone git@github.com:scilus/nf-mouse.git
              ```
            </TabItem>
          </Tabs>
          </details>
          ...
          <CommandOutputs>
            <span slot="command">
              ```bash
              nextflow run nf-mouse/main.nf --help
              ```
            </span>

            <span slot="output">
              ```bash
              Launching `s/nf-mouse/main.nf` [crazy_marconi] DSL2 - revision: ac50d4b1c5
