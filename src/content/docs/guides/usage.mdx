...
<Tabs>
  <TabItem label="Command">
    ```bash
    nextflow run scilus/nf-mouse --input <input_directory> --outdir ./results --lean_output true -profile docker,pre_qc --use_preqc -resume -with-report <report_name>.html
    ```
  </TabItem>
</Tabs>
