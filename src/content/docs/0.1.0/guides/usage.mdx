...
<Steps>
  1. **`-pre_qc`:**
     ...
     :::caution
     **If you want to use the output of the **pre QCed** data you must add --use_preqc. See [parameters section](/nf-mouse_flow/0.1.0/guides/parameters).**
     :::
...
<Tabs>
  <TabItem label="Command">
    ```bash
    nextflow run scilus/nf-mouse_flow -r 0.1.0 --input <input_directory> --outdir ./results --use_preqc true -profile docker,pre_qc -resume
    ```
  </TabItem>
</Tabs>
