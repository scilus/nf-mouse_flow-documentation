...
<Tabs>
  <TabItem label="Command">
    ```bash
    nextflow run scilus/nf-mouse_flow -r 0.1.0 --input <BIDS_directory> --outdir ./results -profile docker,tracking -resume
    ```
  </TabItem>
</Tabs>
